...
class MessageList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Expanded(
        child: SelectionArea(
          child: ListView.builder(itemCount: messageMap[selectedChat.id]!.length, itemBuilder: (context, index) {
            return Padding(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                "${messageMap[selectedChat.id]![index].timestamp.hour}:${messageMap[selectedChat.id]![index].timestamp.minute}",
